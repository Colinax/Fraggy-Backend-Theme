...
## v1.7.0-alpha2 - Work in progress
...
ToDos:
 * Add stylesheet switcher in login page
 * Move WebFont from Google CDN to Fraggy
 * Optimize theme-only javascript code for better performance
 * Ask community for more wishes
